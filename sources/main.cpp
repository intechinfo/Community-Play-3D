...
// Change this to EDT_OPENGL, EDT_DIRECT3D8 (unsupported) or EDT_DIRECT3D9
...
int main( ) {
	...
	IPostProc* ppRenderer = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	...
	CEffectPostProc* ppBlur = new CEffectPostProc( ppRenderer, dimension2d<u32>( 1024, 512 ), PP_BLUR, 0.01f );
...
int main( ) {
	...
	CLensFlarePostProc* ppFlare1 = new CLensFlarePostProc( ppRenderer, dimension2d<u32>( 1024, 512 ), driver->getTexture("flare.png"), sun, 50.0f );
	CLensFlarePostProc* ppFlare2 = new CLensFlarePostProc( ppFlare1, dimension2d<u32>( 1024, 512 ), driver->getTexture("flare.png"), vector3df( -2000.0f, 50.0f, 1000.0f ) );
...
int main( ) {
	...
	IPostProc* ppRenderer = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	CEffectPostProc* ppBlur = new CEffectPostProc( ppRenderer, dimension2d<u32>( 1024, 512 ), PP_BLUR );
...
int main( ) {
	...
	// Interesting stuff (see previous example for full details)
	IPostProc* ppRenderer = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	CEffectPostProc* ppInvert = new CEffectPostProc( ppRenderer, dimension2d<u32>( 1024, 512 ), PP_INVERT );
	// The second effect is made exactly the same way, but takes ppInvert as the input instead of ppRenderer
	CEffectPostProc* ppBlur = new CEffectPostProc( ppInvert, dimension2d<u32>( 1024, 512 ), PP_BLUR, 0.01f );
...
int main( ) {
	...
	IPostProc* ppRenderer1 = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	IPostProc* ppRenderer2 = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	CEffectPostProc* ppBlur = new CEffectPostProc( ppRenderer2, dimension2d<u32>( 1024, 512 ), PP_BLUR, 0.005f );
	CEffectPostProc* ppOverlay = new CEffectPostProc( ppRenderer1, dimension2d<u32>( 1024, 512 ), PP_OVERLAY, 1.0f );
...
int main( ) {
	...
	// Interesting stuff
	IPostProc* ppRenderer1 = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	IPostProc* ppRenderer2 = new CRendererPostProc( smgr2, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 0u, 0u, 0u ) );
	CTransitionPostProc* ppTransition = new CTransitionPostProc( ppRenderer1, ppRenderer2, dimension2d<u32>( 1024, 512 ), driver->getTexture("terrain-heightmap.bmp") );
...
int main( ) {
	...
	CSplitPostProc* ppSplit = new CSplitPostProc( ppRenderer1, ppRenderer2, dimension2d<u32>( 1024, 512 ), rect<f32>( -0.5f, -1.0f, 0.5f, 0.0f ), rect<f32>( -0.7f, 0.0f, 0.3f, 1.0f ) );
...
int main( ) {
	...
	IPostProc* ppRenderer = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	CEffectPostProc* ppBlurDOF = new CEffectPostProc( ppRenderer, dimension2d<u32>( 1024, 512 ), PP_BLURDOF );
...
int main( ) {
	...
	IPostProc* ppRenderer1 = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	IPostProc* ppRenderer2 = new CRendererPostProc( smgr2, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 0u, 0u, 0u ) );
	CEffectPostProc* ppHaze = new CEffectPostProc( ppRenderer1, dimension2d<u32>( 1024, 512 ), PP_HAZEDEPTH );
...
int main( ) {
	...
	IPostProc* ppRenderer = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255u, 100u, 101u, 140u ) );
	CEffectPostProc* ppMine = new CEffectPostProc( ppRenderer, dimension2d<u32>( 1024, 512 ), GL_OLDMONITOR, DX_OLDMONITOR, EPST_PS_1_2, EPST_PS_2_0, EMT_SOLID, PPF_FROMCODE, 1.0f );
	// Notes:
...
int main() {
	...
	IPostProc* ppRenderer1 = new CRendererPostProc( smgr, dimension2d<u32>( 1024, 512 ), true, true, SColor( 255, 130u, 180u, 230u ) );
	CWaterPostProc* ppWater = new CWaterPostProc( ppRenderer1, dimension2d<u32>( 1024, 512 ), -22.0f );
