	...
	scene::ISceneNode(parent, mgr, id)
{
    ...
    FlareData.push_back(SFlareData(EFTE_CIRCLE, 0.5f, 0.12f, video::SColor(120, 60, 180, 35)));
    FlareData.push_back(SFlareData(EFTE_HALO, 0.45f, 0.4f, video::SColor(200, 100, 200, 60)));
    FlareData.push_back(SFlareData(EFTE_CIRCLE, 0.4f, 0.17f, video::SColor(240, 120, 220, 40)));
    FlareData.push_back(SFlareData(EFTE_CIRCLE, 0.2f, 0.35f, video::SColor(175, 175, 255, 20)));
    FlareData.push_back(SFlareData(EFTE_RING, 0.15f, 0.2f, video::SColor(120, 60, 255, 100)));

	// sun and glow effect at sun position
    FlareData.push_back(SFlareData(EFTE_SUN, 0.0f, 0.75f, video::SColor(255, 255, 255, 255)));
    FlareData.push_back(SFlareData(EFTE_STREAKS, 0.0f, 2.9f, video::SColor(255, 255, 255, 255)));
    FlareData.push_back(SFlareData(EFTE_GLOW, 0.0f, 3.5f, video::SColor(255, 255, 255, 255)));
    FlareData.push_back(SFlareData(EFTE_RING, 0.0f, 1.5f, video::SColor(120, 120, 120, 150)));
	
	// some lenses, halos and circles
    FlareData.push_back(SFlareData(EFTE_LENS, -0.15f, 0.15f, video::SColor(255, 60, 60, 90)));
    FlareData.push_back(SFlareData(EFTE_HALO, -0.3f, 0.3f, video::SColor(120, 60, 255, 180)));
	FlareData.push_back(SFlareData(EFTE_HALO, -0.4f, 0.2f, video::SColor(220, 80, 80, 98)));
    FlareData.push_back(SFlareData(EFTE_CIRCLE, -0.45f, 0.1f, video::SColor(220, 80, 80, 85)));
    FlareData.push_back(SFlareData(EFTE_RING, -0.42f, 0.3f, video::SColor(180, 60, 255, 110)));

	// some small lenses, halos and rings
    FlareData.push_back(SFlareData(EFTE_LENS, -0.55f, 0.2f, video::SColor(255, 60, 60, 130)));
    FlareData.push_back(SFlareData(EFTE_HALO, -0.6f, 0.3f, video::SColor(120, 60, 255, 80)));
    FlareData.push_back(SFlareData(EFTE_LENS, -0.7f, 0.2f, video::SColor(200, 60, 60, 130)));
    FlareData.push_back(SFlareData(EFTE_LENS, -0.71f, 0.2f, video::SColor(200, 60, 130, 60)));
    FlareData.push_back(SFlareData(EFTE_LENS, -0.72f, 0.2f, video::SColor(200, 130, 130, 60)));
    FlareData.push_back(SFlareData(EFTE_LENS, -0.74f, 0.2f, video::SColor(200, 130, 60, 60)));

	// some polyons, lenses and circle
	FlareData.push_back(SFlareData(scene::EFTE_POLY, -0.79f, 0.2f, video::SColor(200, 60, 130, 60)));
	FlareData.push_back(SFlareData(scene::EFTE_POLY, -0.86f, 0.3f, video::SColor(200, 130, 130, 60)));
	FlareData.push_back(SFlareData(scene::EFTE_LENS, -0.87f, 0.3f, video::SColor(180,255,192,178)));
	FlareData.push_back(SFlareData(scene::EFTE_CIRCLE, -0.9f, 0.1f, video::SColor(200, 60, 60, 130)));
	FlareData.push_back(SFlareData(scene::EFTE_POLY, -0.93f, 0.4f, video::SColor(200, 130, 60, 60)));
	
	// finally som polygons 
    FlareData.push_back(SFlareData(EFTE_POLY, -0.95f, 0.6f, video::SColor(120, 60, 255, 120)));
    FlareData.push_back(SFlareData(EFTE_POLY, -1.0f, 0.15f, video::SColor(120, 20, 255, 85)));
}
