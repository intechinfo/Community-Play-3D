...
CWaterShader::CWaterShader() : driver(0), smgr(0), timer(0), currentMaterial(0), matWater(-1), matWaterShader("shaders/Water_vs.glsl"), 
                               matWatershader_ps("shaders/Water_ps.glsl")
{
}
...
const irr::s32 CWaterShader::createMaterial(irr::IrrlichtDevice *pDevice)
{
    ...
    if (gpu)
    {
        ...
        (
         ...
         matWatershader_ps, "pixelMain",  EPST_PS_2_a,
