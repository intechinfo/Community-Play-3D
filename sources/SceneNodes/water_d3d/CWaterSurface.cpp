               ...
               ISceneNode(parent, smgr, id), refRTTSize(RTTSize)
{
  ...
  waterNode->getMaterial(0).setTexture(1, driver->getTexture("shaders/Water/waterNormal.png"));
  waterNode->getMaterial(0).setTexture(2, driver->getTexture("shaders/Water/waterDUDV.png"));
