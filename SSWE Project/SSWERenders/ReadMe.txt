========================================================================
    BIBLIOTHÈQUE MFC (MICROSOFT FOUNDATION CLASS) : Vue d'ensemble du projet SSWERenders
========================================================================


AppWizard a créé cette DLL SSWERenders pour vous. Cette DLL décrit non seulement les bases de l'utilisation de Microsoft Foundation Classes, mais est également un point de départ pour l'écriture de votre DLL.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre DLL SSWERenders.
...
SSWERenders.h
    Il s'agit du fichier d'en-tête principal pour la DLL. Il déclare la classe CSSWERendersApp.

SSWERenders.cpp
    Il s'agit du fichier source principal de la DLL. Il contient la classe    CSSWERendersApp.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) SSWERenders.pch et un fichier de type précompilé nommé StdAfx.obj.
