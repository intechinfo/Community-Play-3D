========================================================================
    BIBLIOTHÈQUE MFC (MICROSOFT FOUNDATION CLASS) : Vue d'ensemble du projet SSWELib
========================================================================


AppWizard a créé cette DLL SSWELib pour vous. Cette DLL décrit non seulement les bases de l'utilisation de Microsoft Foundation Classes, mais est également un point de départ pour l'écriture de votre DLL.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre DLL SSWELib.
...
SSWELib.h
    Il s'agit du fichier d'en-tête principal pour la DLL. Il déclare la classe CSSWELibApp.

SSWELib.cpp
    Il s'agit du fichier source principal de la DLL. Il contient la classe    CSSWELibApp.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) SSWELib.pch et un fichier de type précompilé nommé StdAfx.obj.
