...
namespace scene
{
	...
	public:
		...
		CTerrainSceneNode(ISceneNode* parent, IrrlichtDevice* dev, io::IFileSystem* fs, s32 id,
	...
	private:
		...
		{
			STerrainSData(s32 patchSize, s32 maxLOD, const core::vector3df& position, const core::vector3df& rotation, const core::vector3df& scale)
