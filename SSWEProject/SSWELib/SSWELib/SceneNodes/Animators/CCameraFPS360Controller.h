...
#ifndef __C_CAMERA_FPS_360_CONTROLLER_H_INCLUDED__
#define __C_CAMERA_FPS_360_CONTROLLER_H_INCLUDED__
...
namespace scene
{
	...
	class CCameraAnimatorFPS360Controller : public ISceneNodeAnimatorCameraFPS
	{
	public:

		//! Constructor
		CCameraAnimatorFPS360Controller(gui::ICursorControl* cursorControl, f32 rotateSpeed = 100.0f, f32 moveSpeed = .5f, f32 jumpSpeed=0.f,
			SKeyMap* keyMapArray=0, u32 keyMapSize=0, bool noVerticalMovement=false,
			bool invertY=false);

		//! Destructor
		virtual ~CCameraAnimatorFPS360Controller();
		...
		bool IsConnected();
		void Vibrate(u32 leftVal = 0, u32 rightVal = 0);
