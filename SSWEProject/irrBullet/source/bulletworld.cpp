...
irr::core::vector3df irrBulletWorld::getGravity() {
	return irr::core::vector3df(getPointer()->getGravity().getX(), getPointer()->getGravity().getY(), getPointer()->getGravity().getZ());
}
