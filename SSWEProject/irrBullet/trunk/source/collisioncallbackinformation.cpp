...
ICollisionObject* const ICollisionCallbackInformation::getBody0() const
{
    SCollisionObjectIdentification* identification =
        (SCollisionObjectIdentification*)((btCollisionObject*)(contactManifold->getBody0())->getUserPointer());
...
{
    SCollisionObjectIdentification* identification =
        (SCollisionObjectIdentification*)((btCollisionObject*)(contactManifold->getBody1())->getUserPointer());
