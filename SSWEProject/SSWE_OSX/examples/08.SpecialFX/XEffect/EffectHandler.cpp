...
AmbientColour(0x0), use32BitDepth(use32BitDepthBuffers), useVSM(useVSMShadows)
{
	...
	ScreenRTT = driver->addRenderTargetTexture(ScreenRTTSize, "rt", ECF_A16B16G16R16F);
	ScreenQuad.rt[0] = driver->addRenderTargetTexture(ScreenRTTSize, "rt", ECF_A16B16G16R16F);
	ScreenQuad.rt[1] = driver->addRenderTargetTexture(ScreenRTTSize, "rt", ECF_A16B16G16R16F);
