...
int main()
{
	...
	*/
    ...
    EffectHandler *effect = new EffectHandler(device, core::dimension2du(800, 600), false, true, true);
    SShadowLight ss = SShadowLight(1024, core::vector3df(0), core::vector3df(0),irr::video::SColor(0xffffffff), 
                                   10.0, 10000.0, 90.0 * irr::core::DEGTORAD, false);
    effect->addShadowLight(ss);
