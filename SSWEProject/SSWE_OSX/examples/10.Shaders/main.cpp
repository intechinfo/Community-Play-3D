...
int main()
{
	...
	*/
    ...
    //ADD CLOUDS SYSTEM
    scene::CCloudSceneNode *cloudLayer1 = new scene::CCloudSceneNode(smgr->getRootSceneNode(), smgr);
    ...
    scene::CCloudSceneNode *cloudLayer2 = new scene::CCloudSceneNode(smgr->getRootSceneNode(), smgr);
    ...
    scene::CCloudSceneNode *cloudLayer3 = new scene::CCloudSceneNode(smgr->getRootSceneNode(), smgr);
