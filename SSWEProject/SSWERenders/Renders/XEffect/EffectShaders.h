...
const char *PSSM_DEPTH_V[ESE_COUNT] = {
""
,
"float4x4 WVP;\n"
"float4x4 WV;\n"
...
"    output.Color = mul(WVP, input.Position);\n"
"\n"
"	return output;\n"
"}\n"
};

const char *PSSM_DEPTH_P[ESE_COUNT] = {
""
,
"float Near;\n"
"float Far;\n"
...
"float4 pixelMain(VertexShaderOutput input) : COLOR0\n"
"{\n"
"    float Depth = input.Color.z;\n"
"\n"
"    return float4(Depth , 1.0, 1.0, 1.0);\n"
"}\n"
};

const char *PSSM_V[ESE_COUNT] = {
"\n"
,
"float4x4 WVP;\n"
...
"float4x4 TextureMatrix3;\n"
"int NumSplits;\n"
"\n"
"struct VertexShaderOutput {\n"
"	float4 Position : POSITION;\n"
"	float4 Coord[5] : TEXCOORD0;\n"
"};\n"
"\n"
"struct VertexShaderInput {\n"
"	float4 Position : POSITION;\n"
...
"    output.Position = mul(WVP, input.Position);\n"
"\n"
"    output.Coord[0] = output.Position;\n"
"    output.Coord[1] = mul(TextureMatrix0, input.Position);\n"
"\n"
"    if(NumSplits > 1)\n"
"		output.Coord[2] = mul(TextureMatrix1, input.Position);\n"
"\n"
"    if(NumSplits > 2)\n"
"		output.Coord[3] = mul(TextureMatrix2, input.Position);\n"
"\n"
"    if(NumSplits > 3)\n"
"		output.Coord[4] = mul(TextureMatrix3, input.Position);\n"
"\n"
"	 return output;\n"
"}\n"
};

const char *PSSM_P[ESE_COUNT] = {
""
,
"int NumSplits;\n"
...
"float Bias[4];\n"
"float TextureSize[4];\n"
"sampler2D DepthMap[4];\n"
"sampler2D DepthMap0 : register(s0);\n"
"sampler2D DepthMap1 : register(s1);\n"
"sampler2D DepthMap2 : register(s2);\n"
"sampler2D DepthMap3 : register(s3);\n"
"\n"
"struct VertexShaderOutput {\n"
"	float4 Position : POSITION;\n"
"	float4 Coord[5] : TEXCOORD0;\n"
...
"float4 pixelMain(VertexShaderOutput input) : COLOR0\n"
"{\n"
"    float Distance = input.Coord[0].z;\n"
"\n"
"    float Light = 1.0;\n"
"\n"
"    for(int i = 0; i < 4; i++)\n"
...
"        break;\n"
"\n"
"        if(Distance < SplitDistance[i])\n"
"        {\n"
"            float Depth = input.Coord[i+1].z;\n"
"            float2 ProjectiveCoords = input.Coord[i+1].xy / input.Coord[i+1].w;\n"
"\n"
"            float Shadow = tex2D(DepthMap[i], ProjectiveCoords).r;\n"
"            Light = Shadow + Bias[i] <= Depth ? 0.4 : 1.0;\n"
"\n"
"            break;\n"
"        }\n"
"    }\n"
...
"\n"
"    return float4(nColor.x * Light,nColor.y * Light,nColor.z * Light,1);\n"
"}\n"
};
