...
"        out float4      oCoord[5]   : TEXCOORD0,\n"
"\n"
"    uniform float4x4    WVP,\n"
"    uniform int         NumSplits,\n"
"    uniform float4x4    TextureMatrix[4] )\n"
"{"
"    oPosition = mul(WVP, Position);\n"
"\n"
"    oCoord[0] = oPosition;\n"
"    oCoord[1] = mul( TextureMatrix[0], Position );\n"
"\n"
"    if(NumSplits > 1)\n"
"    oCoord[2] = mul( TextureMatrix[1], Position );\n"
"\n"
"    if(NumSplits > 2)\n"
"    oCoord[3] = mul( TextureMatrix[2], Position );\n"
"\n"
"    if(NumSplits > 3)\n"
"    oCoord[4] = mul( TextureMatrix[3], Position );\n"
"}\n"};

const char* PSSM_P[ESE_COUNT] = {
"test\n"
,
"void pixelMain(float4      Coord[5]    : TEXCOORD0,\n"
"\n"
"        out float4      oColor      : COLOR,\n"
"\n"
"    uniform int         NumSplits,\n"
"    uniform float       SplitDistance[4],\n"
"    uniform float       Bias[4],\n"
"    uniform float       TextureSize[4],\n"
"    uniform sampler2D   DepthMap[4] )\n"
"{\n"
"    float Distance = Coord[0].z;\n"
"\n"
"    float Light = 1.0;\n"
"\n"
"    for(int i = 0; i < 4; i++)\n"
...
"        {\n"
"            float Depth = Coord[i+1].z;\n"
"            float2 ProjectiveCoords = Coord[i+1].xy / Coord[i+1].w;\n"
"\n"
